...
import { Portfoliotable } from '../../../components/dashboard/product/portofolio_compo';
...
//import PortofolioChart from '../../../components/amcharts/portofolioComponent'
...
const ProductList2: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Dashboard: Product List | Techsize
        </title>
      </Head>
      <Box
        component="main"
